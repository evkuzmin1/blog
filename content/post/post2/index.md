...
subtitle: O том, как начать работу с Git. Изучим основы систем контроля версий.

# Summary for listings and search engines
summary: O том, как начать работу с Git. Изучим основы систем контроля версий.

# Link this post with a project
projects: []

# Date published
date: '2024-16-13T00:00:00Z'
